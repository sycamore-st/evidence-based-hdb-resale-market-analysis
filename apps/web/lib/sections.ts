...
const SECTION1_LANDING_ITEMS: SectionLandingItem[] = [
  {
    slug: "dashboard-1",
    title: "Dashboard 1: Market overview",
    kicker: "Section 1 / Dashboard 1",
    description: "Country and town views for transaction volume, pricing, and spatial market differences across Singapore.",
    href: "/section1/dashboard-1",
    ctaLabel: "Open dashboard",
  },
  {
    slug: "dashboard-2",
    title: "Dashboard 2: Budget to space",
    kicker: "Section 1 / Dashboard 2",
    description: "Compare how much floor area different budgets can buy across towns and flat types.",
    href: "/section1/dashboard-2",
    ctaLabel: "Open dashboard",
  },
  {
    slug: "dashboard-3",
    title: "Dashboard 3: Location optimizer",
    kicker: "Section 1 / Dashboard 3",
    description: "Shortlist buildings by budget, amenities, transport access, and nearby context.",
    href: "/section1/dashboard-3",
    ctaLabel: "Open dashboard",
  },
]
