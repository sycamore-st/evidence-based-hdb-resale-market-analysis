...
WEB_ARTIFACTS = ARTIFACTS / "web"
WEB_OVERVIEW_ARTIFACTS = WEB_ARTIFACTS / "overview"
WEB_POLICY_ARTIFACTS = WEB_ARTIFACTS / "policy"
WEB_MODEL_ARTIFACTS = WEB_ARTIFACTS / "model"
